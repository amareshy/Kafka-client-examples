...
public class AvroDataKafkaProducerImpl implements EventProducer
{
    ...
    private final BlockingQueue<ProducerRecord<String, GenericRecord>> queue = new ArrayBlockingQueue<ProducerRecord<String, GenericRecord>>(
        1024);
	...
	props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG,
	    AvroValueSerializer.class.getName());
